...
export default function PptGeneratorPage() {
  ...
  return (
    <ToolPageLayout
      ...
      icon={FileText}
      isLoading={isLoading}
      loadingTitle="Generating Presentation..."
      loadingDescription="Please wait while the AI crafts your slides."
      historyProps={{
    ...
    >
      {selectedPpt ? <PptDetails item={selectedPpt} /> : <NewPptForm onGenerate={handleGenerate} />}
    </ToolPageLayout>
  );
}
