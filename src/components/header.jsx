      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex flex-col items-end">
            <span className="text-sm font-medium text-gray-900">{userInfo?.name || "Demo User"}</span>
            <span className="text-xs text-gray-500">{userInfo?.email || "demo@aihub.com"}</span>
          </div>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuLabel>
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium leading-none">{userInfo?.displayName || "User"}</p>
